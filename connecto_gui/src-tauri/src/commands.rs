...
pub fn get_key_details_in_dir(ssh_dir: &std::path::Path, name: &str) -> Result<LocalKeyInfo, String> {
    use std::fs;
...
pub fn rename_local_key_in_dir(ssh_dir: &std::path::Path, old_name: &str, new_name: &str) -> Result<(), String> {
    use std::fs;
